package Artemis::MCP::Net::Reset::PM211MIP;
...
Artemis::MCP::Net::Reset::PM211MIP - Reset via Infratec PM211MIP multi-socket outlet
...
This configures Artemis MCP to use the PM211MIP plugin for reset and
